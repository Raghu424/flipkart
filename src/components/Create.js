            ...
            <div className='c1'>
                ...
                <div className='c3'>
                    ...
                    <form class="w3-container">
                        ...
                        <input class="w3-input" type="text" placeholder="Enter Mobile Number"/>
                    </form>
                    <p className='c4'>By continuing, you agree to Flipkart's Terms of Use and Privacy Policy.</p>
                    <button className='c5'>Continue</button>
                    <div>
                        <Link to='/login'>
                    <button className='c6'>Existing User? Log in</button>
                    </Link>
                    </div>
                </div>
